...
Transform.functions = {
    ...
    scaleObject: function (vertexes, scale, oldScale) {
    ...
    positionObject: function (vertexes, position, oldPos) {
        for (i = 0; i < vertexes.length; i++) {
    ...
    rotateObject: function (rotation, vertexes, oldRot) {
    ...
    rotateZ3D: function (rot, vertexes) {
    ...
    rotateY3D: function (rot, vertexes) {
        var sin_t = Math.sin(rot);
        var cos_t = Math.cos(rot);
    ...
    rotateX3D: function (rot, vertexes) {
        var sin_t = Math.sin(rot);
        var cos_t = Math.cos(rot);
